...
module.exports = {
    ...
    ANT?L?NK: process.env.ANT?_L?NK === undefined ? 'false' : process.env.ANT?_L?NK,
    AUTOB?O: process.env.AUTO_B?O === undefined ? 'false' : process.env.AUTO_B?O,
    ...
    BRANCH: 'master',
    HEROKU: {        HEROKU: process.env.HEROKU === undefined ? false : convertToBool(process.env.HEROKU),
